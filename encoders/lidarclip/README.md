...
```sh
python train.py --name=lidarclip --checkpoint-save-dir=./ckpt --batch-size 128 --workers 4 --data-dir /root/autodl-tmp/Datasets/nuScenes/ --clip-model ViT-L/14

python extract_pc_features.py --checkpoint=/root/autodl-tmp/wql/mmb4dl/encoders/lidarclip/lidarclip/checkpoint/vit_l_14.ckpt --scene-json-path ./annotations/scene_metadata.json --frame-json-path ./annotations/sequence_metadata.json \
