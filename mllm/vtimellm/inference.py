...
def inference(
    ...
    if frame_indices is None:
        # Callers that hand over a full-scene tensor without metadata still get
        # correct absolute frame numbers; ignored unless the model was trained
        # with the frame-position embedding.
